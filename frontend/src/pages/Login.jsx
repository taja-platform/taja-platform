        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative">
              <div
                className={`relative transition-all duration-200 ${
                  emailFocused || email ? "transform -translate-y-2" : ""
                }`}
              >
                <label
                  htmlFor="email"
            ...
            <div className="relative">
              <div
                className={`relative transition-all duration-200 ${
                  passwordFocused || password ? "transform -translate-y-2" : ""
                }`}
              >
                <label
                  htmlFor="password"
                ...
                <input
                  ...
                  className={`w-full h-14 px-4 pt-6 pb-2 pr-12 bg-gray-50 border transition-all duration-200 rounded-lg text-gray-900 placeholder-transparent ${
                    passwordFocused
                      ? "border-gray-900 bg-white shadow-sm"
                      : "border-gray-300 hover:border-gray-400"
                  } focus:outline-none focus:ring-2 focus:ring-gray-900/10`}
